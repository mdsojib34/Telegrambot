...
CREATE TABLE IF NOT EXISTS app_settings (
  ...
  tutorial_enabled BOOLEAN DEFAULT TRUE, tutorial_video_code VARCHAR(100),
...
INSERT INTO app_settings(id,brand_name,brand_subtitle,hero_text,web_app_url,welcome_text,storage_channel_id)
VALUES ('main','Bangladesh Viral Video','PREMIUM VIDEO HUB','নতুন ও ট্রেন্ডিং ভিডিও খুঁজুন, পছন্দ করুন এবং নিরাপদভাবে আনলক করুন।',NULL,'👋 স্বাগতম! নিচের বাটন থেকে ভিডিও অ্যাপ খুলুন।',NULL)
...
-- V10 onboarding tutorial settings (safe for existing databases)
